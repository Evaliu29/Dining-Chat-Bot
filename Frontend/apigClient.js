...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://2m7vx92603.execute-api.us-east-2.amazonaws.com/test';
    ...
    apigClient.messageGet = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['message', 'id'], ['body']);
        ...
        var messageGetRequest = {
            ...
            queryParams: apiGateway.core.utils.parseParametersToObject(params, ['message', 'id']),
            body: body
        };
